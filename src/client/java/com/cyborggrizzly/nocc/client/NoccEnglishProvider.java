...
public class NoccEnglishProvider extends FabricLanguageProvider {
	protected NoccEnglishProvider(FabricPackOutput dataOutput, CompletableFuture<Provider> registryLookup) {
	...
	public void generateTranslations(Provider wrapperLookup, TranslationBuilder translationBuilder) {
		...
		translationBuilder.add("nocc.options.header", "Command Confirmations");
